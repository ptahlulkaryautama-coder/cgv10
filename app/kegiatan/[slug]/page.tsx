      ...
      <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20 xl:px-10">
        <div className="grid gap-8 lg:grid-cols-[0.72fr_1.28fr] lg:items-start">
          <aside className="space-y-4">
            <PlaceholderNotice>
              Mode Tinjauan Pengurus: halaman ini adalah contoh dokumentasi,
              bukan arsip resmi. Tidak ada backend, database, login, upload
              system, CMS, atau admin dashboard.
            </PlaceholderNotice>
          ...
          <div className="space-y-6">
            <article className="rounded-2xl border border-accent/45 bg-accent-soft/45 p-5 shadow-sm sm:p-6">
              ...
              <h2 className="mt-3 text-2xl font-semibold tracking-tight text-foreground">
                Contoh format arsip kegiatan warga.
              </h2>
            ...
            <article className="rounded-2xl border border-border bg-surface p-5 shadow-sm sm:p-6">
              ...
              <h2 className="mt-3 text-2xl font-semibold tracking-tight text-foreground">
                Visual dibuat sebagai contoh kurasi.
              </h2>
            ...
            <article className="rounded-2xl border border-border bg-surface p-5 shadow-sm sm:p-6">
              ...
              <h2 className="mt-3 text-2xl font-semibold tracking-tight text-foreground">
                Keterangan singkat untuk bahan review.
              </h2>
              <div className="mt-6 grid gap-4 sm:grid-cols-3">
